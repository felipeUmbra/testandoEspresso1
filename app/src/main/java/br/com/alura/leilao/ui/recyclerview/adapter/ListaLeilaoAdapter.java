...
public class ListaLeilaoAdapter extends RecyclerView.Adapter<ListaLeilaoAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(viewCriada, onItemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Leilao leilao = pegaLeilaoPorPosicao(position);
        holder.vincula(leilao, formatadorDeMoeda);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView, final OnItemClickListener onItemClickListener) {
            super(itemView);
            this.onItemClickListener = onItemClickListener;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (ViewHolder.this.onItemClickListener != null) {
                        ViewHolder.this.onItemClickListener.onItemClick(leilao);
                    }
                }
            });
        }

        void vincula(Leilao leilao, FormatadorDeMoeda formatadorDeMoeda) {
            this.leilao = leilao;
